...
-1!=a.indexOf(c.value);favourites.dispatchEvent(new Event("change"))}else if(b=/\/sd\/Aux_Outputs\/([0-9]+)\/Buss_Trim\/name/.exec(a.address))for(b=b[1],c=$jscomp.makeIterator(auxSelect.options),d=c.next();!d.done;d=c.next())d=d.value,d.value==b&&(d.innerHTML=a.args[0]);else if(b=/\/sd\/Input_Channels\/([0-9]+)\/Channel_Input\/name/.exec(a.address))for(c=$jscomp.makeIterator(document.querySelectorAll('input[data-channel="'+b[1]+'"]')),b=c.next();!b.done;b=c.next())b.value.previousElementSibling.innerHTML=
a.args[0];else if(b=new RegExp("/sd/Input_Channels/([0-9]+)/Aux_Send/"+auxSelect.value+"/send_level"),b=b.exec(a.address))for(c=$jscomp.makeIterator(document.querySelectorAll('input[data-channel="'+b[1]+'"].volumeInput')),b=c.next();!b.done;b=c.next())b=b.value,b.parentNode.style.setProperty("--value",100*a.args[0]+"%"),b.value=a.args[0];else if(b=new RegExp("/sd/Input_Channels/([0-9]+)/Aux_Send/"+auxSelect.value+"/send_pan"),b=b.exec(a.address))for(c=$jscomp.makeIterator(document.querySelectorAll('input[data-channel="'+
b[1]+'"].panInput')),b=c.next();!b.done;b=c.next())b=b.value,b.parentNode.style.setProperty("--value",100*a.args[0]+"%"),b.value=a.args[0]}
